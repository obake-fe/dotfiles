# Generated by Powerlevel10k configuration wizard on 2020-09-20 at 17:05 JST.
...
() {
  ...
  # Green prompt symbol if the last command succeeded. 矢印
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=032
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=032
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=250
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%250F'  # yellow foreground
      local  untracked='%248F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND=32
